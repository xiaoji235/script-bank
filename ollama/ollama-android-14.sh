...
echo "正在复制仓库..."
repeat_until_success git clone https://cccccccccccccccccccccccccccccccccccccccccccccccccccc.cc/https://github.com/ollama/ollama.git
...
echo "ollama serve || ollama run deepseek-r1:14b" >> $PREFIX/etc/termux-login.sh
